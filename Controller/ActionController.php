...
use Videl\TNGroupBundle\Entity\Action;
use Videl\TNGroupBundle\Form\ActionType;
...
class ActionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TNGroupBundle:Action')->findAll();

        return $this->render('TNGroupBundle:Action:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TNGroupBundle:Action:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TNGroupBundle:Action')->find($id);
        ...
        return $this->render('TNGroupBundle:Action:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TNGroupBundle:Action:edit.html.twig', array(
            'entity'      => $entity,
